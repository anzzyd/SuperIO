...
public:
...

	{
		...
		vsnprintf(szEntry, sizeof(szEntry)-1, szString, args);
...

	{
		...
		_snprintf(szEntry, sizeof(szEntry)-1, "Function: %s, %s", lpFunction, (LPCTSTR)lpMsgBuf);
...
public:
...

	{
		...
		_vsnprintf(szEntry, sizeof(szEntry)-1, szString,args);
