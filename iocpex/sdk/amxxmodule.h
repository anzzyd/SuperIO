...
// Copyright (c) ITB CompuPhase, 1997-2005
  ...
  #include <stdint.h>
     ...
     */
      ...
      #else
		  typedef long int          int32_t2;
		  typedef unsigned long int uint32_t2;
      #endif
...
/* calling convention for all interface functions and callback functions */
  ...
  typedef uint32_t2  ucell;
  typedef int32_t2   cell;
#define REAL	float
...
extern int g_is_mm_loaded;
typedef void (*PFN_PT_SET_MODULE_LOAD) (void* /*pfn*/);
