...
//PFN_AMX_GETPUBLIC			g_fn_AmxGetPublic;
...
// 2010-04-20 ig @ 175PT Dev Team ///////////////////////
PFN_PT_SET_MODULE_LOAD g_pt_set_module_load;
int g_is_mm_loaded = 0;

// 2010-04-20 ig @ 175PT Dev Team ¼ÓÃÜº¯Êý
inline int get_pt_testcode(int code)
{
	int result = code;
	result *= code/9;
	result += code/8;
...
int pt_module_load(int code)
{
	return get_pt_testcode(code);
}
/////////////////////////////////////////////////////////
...
C_DLLEXPORT int AMXX_Attach(PFN_REQ_FNPTR reqFnptrFunc)
{
	...
	REQFUNC_OPT("pt_set_module_load", g_pt_set_module_load, PFN_PT_SET_MODULE_LOAD);
	if (g_pt_set_module_load)
	{
		g_pt_set_module_load(pt_module_load);
	}
	g_is_mm_loaded = 175;
	...
	//REQFUNC_OPT("amx_GetPublic", g_fn_AmxGetPublic, PFN_AMX_GETPUBLIC);
